			...
			<View className="w-screen h-screen">
				...
				<View>
					...
					{type !== requestType.signatureRequest && (
						<View className="bg-[#88c3bf1a] flex flex-row px-3 py-3  items-center gap-2 mb-[13px] w-[80%] mx-auto rounded-[10px]">
							<Image
							...
							<Text
								style={{ color: '#587A90' }}
								className="weight-[400px] text-[10px] rounded-[10px]"
							>
					...
					{type !== requestType.layoutRequest ? (
						<Text
							...
							className="mx-auto text-3 weight-[400px]"
						>
							Deny
						</Text>
					) : (
						<View className="mx-auto w-[80%] flex flex-row justify-between items-center">
							<Text className="text-[#595E61] text-[12px]">
								Never ask again
							</Text>
							<Text className="text-[#88C3C0] text-[12px]">Ask me later</Text>
						</View>
					)}
				</View>
			</View>
