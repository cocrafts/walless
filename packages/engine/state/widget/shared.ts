...
export const mockWidgets: WidgetDocument[] = [
	{
		...
		storeMeta: {
			iconUri: '/img/explore/logo-solid-aptos.svg',
			iconSize: 40,
			iconColor: 'transparent',
			coverUri: '/img/explore/thumbnail-aptos.svg',
			description:
				'Aptos is a Layer 1 for everyone. In the Ohlone language, "Aptos" means "The People."',
			loveCount: 46,
			activeCount: 202,
		},
		networkMeta: {
			backgroundUri: '/img/network/sky-card-bg.png',
			markUri: '/img/explore/logo-trans-aptos.svg',
			iconUri: '/img/explore/logo-trans-aptos.svg',
			iconColor: 'transparent',
			iconSize: 40,
		},
	},
